...
export declare function CharacterSheet({ name, player, secte, clan, generation, characteristics, bloodPool, humanity, willpower, dammages }: CharacterSheetProps): React.JSX.Element;
