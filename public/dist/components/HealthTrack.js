...
function BoxCell({ traits }) {
    ...
    return (React.createElement("div", { className: styles.marker, role: "group", "aria-label": `Health box with ${level} of ${TRAITS_PER_BOX} damages` },
        React.createElement("div", { className: styles.traits, "aria-hidden": true }, Array.from({ length: TRAITS_PER_BOX }, (_, i) => (React.createElement("span", { key: i, className: i < level ? styles.traitOn : styles.traitOff }))))));
}
